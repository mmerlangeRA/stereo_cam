...
if __name__ == '__main__':
    ...
    images_list = [r'C:\Users\mmerl\projects\PIDNet\samples\frankfurt_000000_002196_leftImg8bit.png']
    print(images_list)
    sv_path = r'C:\Users\mmerl\projects\PIDNet\samples\newoutput\'
    ...
    with torch.no_grad():
        for img_path in images_list:
            ...
            if not os.path.exists(sv_path):
                os.mkdir(sv_path)
            print("saving to", sv_path+img_name)
