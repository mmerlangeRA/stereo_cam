...
if __name__ == "__main__":
    equirectangular_path = r"C:\Users\mmerl\projects\stereo_cam\Photos\test\image_L_307_20240730_143131_519000_7147.jpg"
    ...
    signWindow= AttentionWindow(3620,3694,1260,1405,False)
    signWindow= AttentionWindow(3615,3700,1255,1410,False)
    ...
    # cv2.waitKey(0)
    signImage = cv2.imread(r"C:\Users\mmerl\projects\stereo_cam\panneaux\AB23-transformed.png")
    ...
    cv2.imwrite(get_static_path('equirect_sign_image.png'), blended)
    ...
    optimizedTransform = signMatcher.optimize_sign_position_and_orientation(
        ...
        sign_img=signImage,
        signWindow=signWindow,
        estimatedSignTransform=estimatedTransform
    )
    ...
    cv2.imwrite(get_static_path('optimized.png'), blended)
